...
export default function AddService({setOpenModal,id}) {
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        <div className="flex flex-row-reverse -mx-3 mb-4">
                            <div className="w-full md:w-2/4 px-3 mb-6 md:mb-0">
                                <label form="name_model" className="block mb-2 text-gray-700 font-medium  text-right">اسم الخدمة</label>
                                <input type="text" id="name_model" {...register("name_model", { required: true })} name="name" value={value.name} onChange={handleChange} className="w-full border border-gray-300 rounded-md py-1 px-4 text-gray-700 focus:border-indigo-500 focus:outline-none text-right" />
