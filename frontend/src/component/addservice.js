            ...
            <div className="pt-0 text-center">
                <div className="flex flex-col px-6 py-4 max-w-3xl">
                        ...
                        <div className="flex flex-row-reverse justify-centeritems-center -mx-3 mb-4">
                            ...
                            <div className="w-full md:w-2/4 md:mb-0 flex" dir={'rtl'}>
                                <input type={'checkbox'} id={"service"} name={"passport"} value={'value.passport'} />
                        ...
                        <div className="flex flex-row-reverse justify-center items-center -mx-3 mb-4">
                            <div className="w-full md:w-2/4 md:mb-0 flex" dir={'rtl'}>
                                <input type={'checkbox'} id={"service"} name={"license"} value={'value.license'} />
                                <label htmlFor={"license"} className={'mr-2 font-bold inline-flex'}>رخصة</label>
                            </div>
                            <div className="w-full md:w-2/4 md:mb-0 flex" dir={'rtl'}>
                                <input type={'checkbox'} id={"service"} name={"medical_certificate"} value={'value.medical_certificate'} />
                                <label htmlFor={"medical_certificate"} className={'mr-2 font-bold inline-flex'}>إثبات طبي</label>
                            </div>
                            <div className="w-full md:w-2/4 md:mb-0 flex" dir={'rtl'}>
                                <input type={'checkbox'} id={"service"} name={"family_status_certificate"} value={'value.family_status_certificate'} />
