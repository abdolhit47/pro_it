            ...
            <div class="bg-gray-100 shadow-md rounded-lg px-8 py-6 w-full max-w-md">
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div class="mb-4"  dir="rtl">
                        ...
                        <input type="text" id="userName" name='userName'{...register("userName", { required: true })} value={value.userName} onChange={handleChange} class="shadow-sm rounded-md w-full px-3 py-2 border border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500" placeholder="Ahmed, Ali...etc"/>
                        {errors.userName&&<p className="block text-red-500 text-xs  mt-1 w-full">لا يمكن ترك هذا الحقل فارغًا.</p>}
                    </div>
                    <div class="mb-4"  dir="rtl">
                        <label for="password" class="block text-sm font-medium text-gray-700 mb-2">كلمة المرور</label>
                        <input type="password" id="password" name='password'{...register("password", { required: true })} value={value.password} onChange={handleChange} class="shadow-sm rounded-md w-full px-3 py-2 border border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500" placeholder="أدخل كلمة المرور"/>
                    ...
                    <button  type="submit" class="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700">تسجيل الدخول</button>
