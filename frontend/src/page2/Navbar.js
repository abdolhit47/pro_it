...
function Navbar() {
    ...
    return (
        <>
            <Sideba/>
            <nav
                class="flex  inset-x-0 top-0 flex justify-between  pt-4 pb-2 items-center md:max-w-[calc(100vw-16rem)] sticky backdrop-blur-md border-2 border-b-stone-700 bg-white/30">
                <ul class="md:flex space-x-0 mx-8">
                    <li>
                        ...
                        <Menu
                            ...
                            PaperProps={{
                                style: {
                                    maxHeight: ITEM_HEIGHT * 4.5, width: '20ch',
                                },
                            }}
                        >
                ...
                <p class="text-black text-3xl font-bold ml-auto pr-4" style={{fonSize: "30px"}}>نظام مساعدة
                    المكفوفين</p>
            </nav>
        </>
    );
