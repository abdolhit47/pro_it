...
function ShowOfficeH({office}){
    ...
    if(localStorage.getItem('selected_office_name')!==showoffice.name || localStorage.getItem('selected_office_id')!==id) {
        localStorage.setItem('selected_office_id', id);
        localStorage.setItem('selected_office_name', showoffice.name);
        console.log(showoffice.name)
    }
    return(
        <>
